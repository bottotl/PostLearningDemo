//
//  LTStatusTimelineViewController.m
//  LTDynamicCellDemo
//
//  Created by Lintao.Yu on 15/12/13.
...
@implementation LTStatusTimelineViewController
- (instancetype)init {
    self = [super init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    LTStatusCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID];
    if (!cell) {
        cell = [[LTStatusCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
        cell.delegate = self;
    }
